...
public class Binary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteRow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tableInput.getChildCount() > 2) {
                    ...
                    Toast toast =  Toast.makeText(Binary.this, "Min One Process Required", Toast.LENGTH_SHORT);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tableInput.getChildCount() <= 2) {
                    Toast toast=  Toast.makeText(Binary.this, "Atleast One Process Required", Toast.LENGTH_SHORT);
                    toast.show();
                    count = 1;
                }
                else {
                    ...
                    count = 0;
                    setAdd_Row();
                    Toast toast= Toast.makeText(Binary.this, "Deleted All Process \n Except One", Toast.LENGTH_SHORT);
                    toast.show();
                }
        ...
        btn_Compute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tableInput.getChildCount() <= 1) {
                    Toast toast=Toast.makeText(Binary.this, "No Process Available", Toast.LENGTH_SHORT);
                ...
                if (proc.getText().toString().equals("")) {
                    ...
                    Toast toast = Toast.makeText(Binary.this, "Input of Number of Processes Missing", Toast.LENGTH_SHORT);
                    toast.show();
                }
                else {
    ...
    public void setAdd_Row(){
        ...
        int maxLength =20;
        tableRow = new TableRow(Binary.this);
        Process = new TextView(Binary.this);
        E = new TextView(Binary.this);
        B = new TextView(Binary.this);
        F = new TextView(Binary.this);
        ...
        //  Process.setBackground(ContextCompat.getDrawable(Binary.this, R.drawable.table_process_cell_bg));
        E.setId(ENTRY_ID + idVal);
        //  AT.setBackground(ContextCompat.getDrawable(Binary.this, R.drawable.table_cell_bg));
        B.setId(BUFFER_ID + idVal);
        //  MN.setBackground(ContextCompat.getDrawable(Binary.this, R.drawable.table_cell_bg));
        ...
        if(count%2==1)
            tableRow.setBackground(ContextCompat.getDrawable(Binary.this, R.drawable.table_row_bg));

        else
            tableRow.setBackground(ContextCompat.getDrawable(Binary.this, R.drawable.table_row_background_white));
